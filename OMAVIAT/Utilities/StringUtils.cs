...
{
	public static string SerializeYML(this object obj)
	{
		return new SerializerBuilder()
			.WithNamingConvention(CamelCaseNamingConvention.Instance).Build().Serialize(obj);
	}

	public static T DeserializeYML<T>(this string yml)
	{
	...
	{
		var chars = !without_digits
			? "qwertyuiopasdfghjklzxcvbnm1234567890qwertyuiopasdfghjklzxcvbnm1234567890qwertyuiopasdfghjklzxcvbnm1234567890qwertyuiopasdfghjklzxcvbnm1234567890qwertyuiopasdfghjklzxcvbnm1234567890qwertyuiopasdfghjklzxcvbnm1234567890"
	...
	{
		return string.Join(" ",
			text.GetWordsLocal(text.Count(e => e is ' ') < count ? text.Count(e => e is ' ') : count));
	}
	...
	public static string[] GetWordsLocal(this string input, int count = -1, string[] wordDelimiter = null,
	...
	public static string ConvertFullNameToShortName(string s)
	{
		if (string.IsNullOrEmpty(s = s.Trim()))
			return string.Empty;
		string[] sss = s.Split(" ");
		var sb = new StringBuilder(sss[0] + " ");
