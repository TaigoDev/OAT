...
public class CMK
{
	...
	public CMK(int id, string name, List<string> compositions, string history, string descriptionOfWork,
		string achievements, string plans)
	{
		this.id = id;
		this.name = name;
	...
	public CMK(string name, List<string> compositions, string history, string descriptionOfWork, string achievements,
		string plans)
	{
		this.name = name;
		this.compositions = compositions;
