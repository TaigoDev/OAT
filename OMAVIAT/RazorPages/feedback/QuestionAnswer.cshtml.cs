...
public class QuestionAnswerModel : PageModel
{
	...
	[BindProperty]
	[Required(ErrorMessage = "Вы не заполнили ваше имя")]
	public string name { get; set; }

	[BindProperty]
	[Required(ErrorMessage = "Вы не заполнили вашу почту")]
	public string email { get; set; }

	[BindProperty]
	[Required(ErrorMessage = "Вы не заполнили ваш телефон")]
	public string telephone { get; set; }

	[BindProperty]
	[Required(ErrorMessage = "Вы не заполнили ваш вопрос")]
	public string description { get; set; }

	[BindProperty]
	[Required(ErrorMessage = "Вы не выбрали тему")]
	...
	public IActionResult OnPost()
	{
		...
		var sendTo = topic switch
		{
			...
			"Профориентация" or "Трудоустройство" or "Приёмная комиссия" or "Курсовая подготовка" => "savin@oat.ru",
