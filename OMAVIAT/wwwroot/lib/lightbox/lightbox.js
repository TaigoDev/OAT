...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    ...
    $('<div id="lightboxOverlay" tabindex="-1" class="lightboxOverlay"></div>' +
		...
		'<div class="lb-nav">' +
		'<a class="lb-prev" role="button" tabindex="0" aria-label="Previous image" href=""><img src="/lib/lightbox/images/prev.svg" alt=""></a>' +
		'<a class="lb-next" role="button" tabindex="0" aria-label="Next image" href="" ><img src="/lib/lightbox/images/next.svg" alt=""></a>' +
		'</div>' +
		...
		'<div class="lb-closeContainer"><a class="lb-close" role="button" tabindex="0"></a></div></div></div></div>').appendTo($('body'));
