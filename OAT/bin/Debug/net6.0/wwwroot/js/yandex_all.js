window.Ya || (window.Ya = {}),
    ...
    Ya.Site || (Ya.Site = function (o, n) {
        var r, i = "1.4.0", s = "1.6.2", t = "2.0", c = "initial", l = [], e = o.location, u = n.jQuery, a = "https:", d = [], p = !1;
    ...
    Ya.Site.Form || (Ya.Site.Form = function (t, n) {
        ...
        function p(e) {
            ...
            0 !== t.length && (this.id = p.blockName + p.instances.length,
                ...
                null === this.params.searchid && null === this.params.clid || (this.searchId = this.params.searchid || this.params.clid,
                    ...
                    this.buildAction().buildHTML(r, i).buildSuggest().buildInputHint().addOpensearch().initEvents(),
                    this.set({
                        text: a,
        ...
        return r.buildAction = function () {
            ...
            ,
            r.buildCSS = function () {
                var a, r = "", e = -1 !== n.navigator.userAgent.toLowerCase().indexOf("msie") && (!t.documentMode || t.documentMode < 8);
            return r += "#ya-site-form,#ya-site-form .ya-site-form__form,#ya-site-form .ya-site-form__input,#ya-site-form .ya-site-form__input-text,#ya-site-form .ya-site-form__search-precise,#ya-site-form .ya-site-form__submit{font-size:12px!important;color:#fff!important}#ya-site-form .ya-site-form__form-form{display:block;margin:0;padding:0;border-radius:2px;}#ya-site-form .ya-site-form__input{margin:0;padding:0}#ya-site-form .ya-site-form__search-precise{margin:0}#ya-site-form .ya-site-form__search-precise__radio{padding:0}#ya-site-form .ya-site-form__gap,#ya-site-form .ya-site-form__gap-i,#ya-site-form .ya-site-form__logo-img{margin:0;padding:0}#ya-site-form{margin:0!important;padding:0!important}#ya-site-form .ya-site-form__logo-wrap{width:65px;vertical-align:top;border-collapse:collapse}#ya-site-form .ya-site-form__logo{display:block;width:52px;margin:0;padding:0 6px 0 0;text-decoration:none}#ya-site-form .ya-site-form__logo-img{width:52px;height:21px;border:0!important}#ya-site-form .ya-site-form__search-wrap{border-collapse:collapse}#ya-site-form .ya-site-form__search{font-size:12px!important;width:100%;border-radius:20px;}#ya-site-form .ya-site-form__search-input{padding:6px}#ya-site-form .ya-site-form__search-input-layout,#ya-site-form .ya-site-form__search-input-layout-l,#ya-site-form .ya-site-form__search-input-layout-r{font-size:12px!important;padding:0;vertical-align:middle;border:0;border-collapse:collapse}#ya-site-form .ya-site-form__search-input-layout,#ya-site-form .ya-site-form__search-input-layout-l{width:100%}#ya-site-form .ya-site-form__search-precise{padding:0 18px 5px 6px;text-align:left;vertical-align:top}#ya-site-form .ya-site-form__search-precise-i{white-space:nowrap}#ya-site-form .ya-site-form__search-precise__radio{width:auto;margin:0 .3em 0 0;vertical-align:middle;background:0 0}#ya-site-form .ya-site-form__search-precise__label{margin:0 .4em 0 0;padding:0;vertical-align:middle}#ya-site-form .ya-site-form__input-text{width:100%;margin:0!important;cursor:text;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;background-color:#fff;text-indent: 15px;outline-style:none;-webkit-appearance:textfield}#ya-site-form .ya-site-form__input-text_type_hint{background-repeat:no-repeat;background-position:.2em 50%}#ya-site-form .ya-site-form__submit{display:block;width:auto;margin:0 0 0 10px;background-color:#528dfa;padding: 8px;}#ya-site-form .ya-site-form__arrow-wrap{overflow:hidden;width:30px;padding:0;vertical-align:middle}#ya-site-form .ya-site-form__arrow{position:relative}#ya-site-form .ya-site-form__arrow-a{position:absolute;top:50%;right:0;width:0;height:0;margin-top:-59px;border:solid transparent;border-width:59px 0 59px 30px;-moz-border-end-style:dotted}#ya-site-form .ya-site-form__wrap{width:100%;height: 40px;table-layout:fixed;border-collapse:collapse}#ya-site-form .ya-site-form__gap{border:0}#ya-site-form .ya-site-form__gap-i{width:9em}#ya-site-form.ya-site-form_arrow_yes .ya-site-form__search-input{padding-right:0}#ya-site-form.ya-site-form_logo_left .ya-site-form__logo{margin-top:4px;margin-left:5px}#ya-site-form.ya-site-form_logo_top .ya-site-form__logo{display:block;margin:6px 0 0 6px}#ya-site-form .ya-site-form__submit_type_image{width:19px;height:15px;outline:0;cursor:pointer;border:0;}",
                    e && (r += "undefined"),
                ...
                r += "#ya-site-form ." + p.blockName + "__form * { font-size: " + this.params.fontsize + "px !important; border-radius: 10px;}",
            ...
            r.buildHTML = function (e, t) {
                ...
                return this.isArrow() && (this.$node.addClass(p.blockName + "_arrow_yes"),
                    d = '<div class="' + p.blockName + '__arrow-wrap"><div class="' + p.blockName + '__arrow"><div class="' + p.blockName + '__arrow-a"></div></div></div>'),
                    s = '<div class="' + p.blockName + '__logo-wrap"><a class="' + p.blockName + '__logo" href="http://www.yandex.' + this.params.tld + '"><img class="' + p.blockName + '__logo-img"src="' + this.pathToImages() + "yandex52x21x24-" + this.params.logo + '.png"alt="' + this.i18n("yandex") + '"/></a></div>',
                    ...
                    i = '<div class="' + p.blockName + '__search-input-layout"><tr><div class="' + p.blockName + '__search-input-layout-l"><div class="' + p.blockName + '__input"><input name="text" type="search" value="" class="' + p.blockName + '__input-text" ' + (this.hasPlaceholder() ? 'placeholder="' + ("string" != typeof (o = this.params.input_placeholder) ? "" : o.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&apos;").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")) + '"' : "") + (e ? ' style="' + e + '"' : "") + '/></div></div><div class="' + p.blockName + '__search-input-layout-r">' + n + "</div></div></div>",
                    r = '<div class="' + p.blockName + '__search" cellpadding="0" cellspacing="0">' + u + '<div><div class="' + p.blockName + '__search-input">' + i + "</div></div>" + c + '<div><div class="' + p.blockName + '__gap"><div class="' + p.blockName + '__gap-i" /></div></div></div>',
                    a = '<div class="' + p.blockName + '__form"><div class="' + p.blockName + '__wrap" cellpadding="0" cellspacing="0"><tr>' + l + '<div class="' + p.blockName + '__search-wrap">' + r + "</div>" + d + "</div></div></div>",
                    this.$node.html(a),
    ...
    Ya.Site.Results || (Ya.Site.Results = function (p, h) {
        ...
        return t.onHashChange = function () {
            ...
            ,
            t.initHTML = function () {
                var c, l = this, e = encodeURIComponent(h.location.protocol + "//" + h.location.host + h.location.pathname + h.location.search), t = p.createElement("div"), u = l.node, d = "callback";
                Ya.Site.$ && ((c = Ya.Site.$)(u).empty(),
                    ...
                    c(u).bind("Ya.site-get-results", function (e, t) {
                        var a, r, i = m.CheckVisibility.getWindowSize(), n = m.CheckVisibility.getWindowScroll(), s = m.CheckVisibility.getBlockOffset(u), o = p.createElement("a");
    ...
    Ya.Site.CheckVisibility || (Ya.Site.CheckVisibility = function (e, o) {
        var c, l, u, t = "CSS1Compat", d = "resize", p = "load", h = "scroll", a = "clientWidth", r = "clientHeight", i = "scrollLeft", n = "scrollTop", s = e.documentElement, m = !1, f = Ya.Site;
        function g() {
    ...
    Ya.Site.Iframe || (Ya.Site.Iframe = function (i, n) {
        var a, e, t, r = "not_inited", s = Ya.Site, o = s.queryParams, c = ["p", "how", "surl", "constraintid", "date", "within", "from_day", "from_month", "from_year", "to_day", "to_month", "to_year", "noreask", "available", "priceLow", "priceHigh", "categoryId"], l = {}, u = {
            length: 0
        };
        function d() {
